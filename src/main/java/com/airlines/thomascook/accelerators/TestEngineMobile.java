...
public class TestEngineMobile {
  ...
  //  public EventFiringWebDriver Driverappium=null;
   ...
   /*public String stageBuildNumber="28";
    ...
    @Parameters({"environment", "browser","baseUrl"})
    public void beforeMethod(String environment, String browser,String baseUrl) throws IOException, InterruptedException
    {
        ...
        if(environment.equals("mobile")){
            this.setAppiumDriver(browser);
         //  this.appiumdriver = appiumdriver;
          //  this.Driver = new EventFiringWebDriver(this.appiumdriver);
        }
...
//        updateStatusMapFile(statusMapFilePath);
   ...
   /* private void setWebDriverForLocal(String browser) throws IOException, InterruptedException
    ...
    private void setAppiumDriver(String browser) throws IOException, InterruptedException
    {
        ...
        capabilities.setCapability("chrome.switches", Arrays.asList("--disable-extensions","--disable-web-security",
