...
import com.airlines.thomascook.businesslogic.HealthCheck_CommonReusables;
...
public class HealthCheck_GeneralScenario extends HealthCheck_CommonReusables implements OR_HomePage,OR_FlightDetails,OR_EssentialsComman,OR_ExtrasComman {
    ...
    public Object[][] testCases() throws Exception{
        ...
        Object[][] testObjArray = getTestData(System.getProperty("user.dir")+"\\TestData\\TestData_HealthCheck.xls","TCTestData");
