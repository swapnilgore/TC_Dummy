...
public interface OR_HomePage {
    ...
    String roundTrip = "css=#btngroup_return";
    ...
    String passContBtn = "css=.btn.btn--large";
    ...
    String monthYearTxt = "css=tca-low-fare-calendar div.row div button strong";
    ...
    String flyTypes = "css= fieldset label input[name='flight_radio_btngroup']";
